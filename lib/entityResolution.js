...
// lowercase, strip punctuation except '&', drop stopwords, collapse whitespace
function normalizeName(raw) {
  if (!raw) return '';
  const stripped = String(raw).toLowerCase().replace(/[^\w\s&]/g, ' ');
...
module.exports = { normalizeName, dbaTail, buildLocationIndex, bidderNormForms, matchBidder, FUZZY_THRESHOLD };
